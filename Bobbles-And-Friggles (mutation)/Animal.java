...
////////////////////////Variables//////////////////////
  ...
  //Mutation Chances
  private float[] mutationChances = new float[6];
...
//////////////////////////Mutation///////////////////////
  ...
  public int mutate(int attribute, float mutationChance){
    if(mutationChance != 0){
      if(Math.random()<=mutationChance){
        ...
        if((int)Math.floor(Math.random()+0.5)==0){
  ...
  public float[] getMutationChances(){
	return mutationChances;
  }

  public void setMutationChances(float[] muCh){
	mutationChances = muCh;
  }
}