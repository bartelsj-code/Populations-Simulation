...
//////////////////////Variables/////////////////////////
  ...
  // bobble mutation list
  private float[] bobbleMfacts = new float[6];
  //friggle attribute list
  private int[] friggleFacts = new int[6];
   // friggle mutation list
  private float[] friggleMfacts = new float[6];
...
///////////////////////Setting up Simulation///////////////////////
  ...
  public void addBobbles(int bsc){
    ...
    for(int i = 0; i < bobbleStartCount; i++){
      ...
      charlotte.materialize(charlottesHome,bobbleFacts[0],bobbleFacts[1],areaGrid,bobbleFacts[2],bobbleFacts[3],bobbleFacts[4],bobbleFacts[5],bobbleMfacts);
...
//////////// Get attributes from Facts.txt files//////////////////
  ...
  public void getMfacts(String input, float[] type){
	System.out.println(input.split("\\.")[0]+":\n");
	String inputFilePath = input;
    File inputFile = new File(inputFilePath);
	Scanner scanner = null;
	...
	while (scanner.hasNextLine()) {
      String line = scanner.nextLine();
      System.out.println(line);
      type[l] = Float.parseFloat(line.split(":")[1]);
      l++;
    }
	scanner.close();
    System.out.println("\n");
  ...
  /**
	*Runs getMfacts() for bobbles
	*/
  public void getBobbleMfacts(){
	getMfacts("Bobble Mutation Likelyhood.txt", bobbleMfacts);
  }
	
  /**
	*Runs getMfacts() for friggles
	*/
  public void getFriggleMfacts(){
	getMfacts("Friggle Mutation Likelyhood.txt", friggleMfacts);
  }
  /**
